...
export default function IncidentLayer() {
    ...
    useEffect(() => {
        ...
        if (map.getSource("temperature-source")) map.removeSource("temperature-source");
        if (map.getLayer("precipitation-layer")) map.removeLayer("precipitation-layer");
        if (map.getSource("precipitation-source")) map.removeSource("precipitation-source");
        ...
        if (hospitalToggle) {
            map.loadImage("/icon/icn_hospital.png",
                (error: any, image: any) => {
                    if (error || !image) return;
        ...
        map.on("click", (e: any) => {
            ...
            if (map.getLayer("trafficIncident")) layersToCheck.push("trafficIncident");
    ...
    }, [eventToggle, hospitalToggle, temperatureToggle, precipitationToggle, mapRef]);
